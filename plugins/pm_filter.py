        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ Mᴏᴠɪᴇ Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ ✧', url ='https://t.me/+rFbpyP1M0fpkMjk1')
                        ]]
                    )
                )
...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, [
        InlineKeyboardButton(f'⛔️  sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ ​ ⛔️', url='https://youtube.com/@Ultimately-YT09?si=ksKizp0BfTYXMm4h')
    ])
    offset = 0
    ...
    if query.data.startswith("file"):
            ...
            if (AUTH_CHANNEL or REQ_CHANNEL) and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("🔰  ᴊᴏɪɴ ꜰᴏʀ ᴍᴏᴠɪᴇs​  🔰", url="https://t.me/theottservice")
                         ]
                        ]
                    )
                )
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton('❤️‍🔥 ᴄʜᴀɴɴᴇʟ​ ❤️‍🔥​', url='https://t.me/thefilmzone9')
                 ]
                ]
            )
        )
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ʏᴛ  ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/@Ultimately-YT09?si=ksKizp0BfTYXMm4h"),
        ],[
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url="https://t.me/+rFbpyP1M0fpkMjk1"),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url="https://t.me/theottservice")
        ],[
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url="https://t.me/thefilmzone9"),
        ...
        buttons = [[
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Harsha_Is_Honest'),
           InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url='https://t.me/thefilmzone9')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʀᴇᴘᴏʀᴛ  ʙᴜɢꜱ  ᴀɴᴅ  ꜰᴇᴇᴅʙᴀᴄᴋ', url='https://t.me/thefilmzone9')
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ɴᴇxᴛ', url='https://t.me/+rFbpyP1M0fpkMjk1')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        buttons = [[
           InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/theottservice'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Harsha_Is_Honest')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help2')
        ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("ᴄʟᴏsᴇ", url="https://t.me/+rFbpyP1M0fpkMjk1")
                  ]]
            reply_markup = InlineKeyboardMarkup(btn)
            await client.edit_message_media(
                query.message.chat.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if IS_TUTORIAL == True:
        ...
        btn.insert(0, [
        InlineKeyboardButton("⛔️  ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ  ⛔️", url=https://t.me/download_t/9)
        ])
